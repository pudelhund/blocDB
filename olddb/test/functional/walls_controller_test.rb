...
class WallsControllerTest < ActionController::TestCase
  ...
  test "should create wall" do
    assert_difference('Wall.count') do
      post :create, wall: { description: @wall.description, location_id: @wall.location_id, name,: @wall.name, }
    end
  ...
  test "should update wall" do
    put :update, id: @wall, wall: { description: @wall.description, location_id: @wall.location_id, name,: @wall.name, }
    assert_redirected_to wall_path(assigns(:wall))
  end
